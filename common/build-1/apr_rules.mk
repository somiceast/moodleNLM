...
#
apr_builddir=/opt/moodle-3.10.0-0/common/build-1
apr_builders=/opt/moodle-3.10.0-0/common/build-1
top_builddir=/opt/moodle-3.10.0-0/common/build-1
...
CPPFLAGS=-DAI_ADDRCONFIG=0 -I/bitnami/lamp73stack-linux-x64/output/sqlite/include -I/bitnami/lamp73stack-linux-x64/output/mysql/include -I/opt/moodle-3.10.0-0/common/include -I/opt/moodle-3.10.0-0/common/include/sasl -I/opt/moodle-3.10.0-0/common/include
LDFLAGS=-L/bitnami/lamp73stack-linux-x64/output/sqlite/lib -L/bitnami/lamp73stack-linux-x64/output/mysql/include -L/opt/moodle-3.10.0-0/common/lib -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
