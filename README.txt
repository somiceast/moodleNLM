...
bitnami-moodle-3.10.0-0-linux-installer.run on Linux or
bitnami-moodle-3.10.0-0-linux-x64-installer.run on Linux 64 bit or
bitnami-moodle-3.10.0-0-windows-installer.exe on Windows or
bitnami-moodle-3.10.0-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-moodle-3.10.0-0-linux.run
...
Stack in /home/user/moodle-3.10.0-0 on Linux or C:\Program Files\Bitnami Moodle Stack
on Windows or /Applications/moodle-3.10.0-0 and that you use port
...
"Cannot open bitnami-moodle-3.10.0-0-linux.run: No application suitable for
...
/home/user/moodle-3.10.0-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami Moodle Stack\apache2\logs\error.log on Windows or
/Applications/moodle-3.10.0-0/apache2/logs/error.log on OS X.
...
Moodle is distributed under the GNU General Public License v3,
which is located at https://www.gnu.org/licenses/gpl-3.0.txt
