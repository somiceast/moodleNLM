...
HTTPD_PIDFILE=/opt/moodle-3.10.0-0/apache2/logs/httpd.pid



HTTPD="/opt/moodle-3.10.0-0/apache2/bin/httpd -f /opt/moodle-3.10.0-0/apache2/conf/httpd.conf"
if [ -f "/opt/moodle-3.10.0-0/apps/bitnami/banner/disable-banner" ] ; then
...
. /opt/moodle-3.10.0-0/apache2/bin/envvars
