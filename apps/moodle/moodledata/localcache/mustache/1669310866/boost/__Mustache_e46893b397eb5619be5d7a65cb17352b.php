...
class __Mustache_e46893b397eb5619be5d7a65cb17352b extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="content text-left mb-5 px-5 py-4" data-region="chooser-option-summary-content-container">
';
...
';
        $buffer .= $indent . '                    <p class="text-left">';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                        >
';
        $buffer .= $indent . '                        <div class="input-group-append z-index-0">
';
...
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                    <p class="text-left" aria-live="assertive" data-region="validation-area"></p>
';
        $buffer .= $indent . '                    <p class="text-left">';
        // 'str' section
        $value = $context->find('str');
