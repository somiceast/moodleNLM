...
/**
 * Strings for component 'theme_adaptable', language 'zh_cn', version '3.10'.
 *
...
$string['coursesectionactivityfurtherinformation'] = '课程页面更多信息';
$string['coursesectionactivityfurtherinformationassign'] = '显示作业信息';
$string['coursesectionactivityfurtherinformationassigndesc'] = '显示分配信息，例如截止日期，提交状态。对于教师/管理员，显示提交的数量。';
$string['coursesectionactivityfurtherinformationchoice'] = '显示选项信息';
$string['coursesectionactivityfurtherinformationchoicedesc'] = '显示选项信息，例如提交状态。对于教师/管理员，显示提交的数量。';
$string['coursesectionactivityfurtherinformationdata'] = '显示数据库信息';
$string['coursesectionactivityfurtherinformationdatadesc'] = '显示数据信息，例如提交状态。对于教师/管理员，显示提交的数量。';
$string['coursesectionactivityfurtherinformationfeedback'] = '显示反馈信息';
$string['coursesectionactivityfurtherinformationfeedbackdesc'] = '显示反馈信息，例如提交状态。对于教师/管理员，显示提交的数量。';
$string['coursesectionactivityfurtherinformationlesson'] = '显示课程信息';
$string['coursesectionactivityfurtherinformationlessondesc'] = '显示课程信息，例如提交状态。对于教师/管理员，显示提交的数量。';
$string['coursesectionactivityfurtherinformationquiz'] = '显示测验信息';
$string['coursesectionactivityfurtherinformationquizdesc'] = '显示测验信息，例如提交状态。对于教师/管理员，显示提交的数量。';
...
$string['coursesectionactivityuseadaptableicons'] = '使用Adaptable主题图标集';
$string['coursesectionactivityuseadaptableiconsdesc'] = '打开此功能可使用Adaptable主题图标。如果关闭, 也请确保您删除目录 adaptable/pix_plugins和 adaptable/pix_core\\ f 以使用默认的 moodle 图标。';
