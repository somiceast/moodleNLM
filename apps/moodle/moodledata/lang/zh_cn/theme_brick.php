...
/**
 * Strings for component 'theme_brick', language 'zh_cn', version '3.10'.
 *
 * @package     theme_brick
 * @category    string
...
<div class="theme_description">
	...
	<h2>关于</h2>
	<p>砖块是一个双列、可变宽的 Moodle 2.0 主题。您可以在主题设置页面修改它的配色。</p>

	<h2>调整</h2>
	<p>本主题基于 Moodle 核心的基本主题和画布主题构建。如果除了设置里提供的定制功能以外，您还想做其它修改，我们建议您创建一个新主题，并将本主题、基础和画布做为父主题。这样这三个核心主题中任意一个的更新都能反映到您的主题上。</p>

	<h2>致谢</h2>
	<p>本主题由 NewSchool Learning 的 John Stabinger 编写和维护。可以通过 contact@newschoollearning.com 联系他。</p>
