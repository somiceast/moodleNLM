...
/**
 * Strings for component 'tool_moodlenet', language 'zh_cn', version '3.10'.
 *
...
$string['aria:enterprofile'] = '输入您的MoodleNet配置文件的URL';
...
$string['enablemoodlenet'] = '启用MoodleNet集成';
...
$string['forminfo'] = '您的MoodleNet配置文件将自动保存在您在这个网站的配置文件中。';
...
$string['inputhelp'] = '或者如果您已经有一个MoodleNet账户，请输入您的MoodleNet配置文件：';
...
$string['moodlenetsettings'] = 'MoodleNet设置';
...
$string['profilevalidationerror'] = '在验证您的配置文件时出现了问题。';
$string['profilevalidationfail'] = '请输入一个有效的MoodleNet配置文件';
