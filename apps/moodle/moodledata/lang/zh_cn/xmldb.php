...
/**
 * Strings for component 'xmldb', language 'zh_cn', version '3.10'.
 *
 * @package     xmldb
 * @category    string
...
$string['duplicatetablename'] = '已经有同名的表';
...
$string['primarykeyonlyallownotnullfields'] = '主键不能为 null';
$string['tablenameempty'] = '表名不可为空';
