...
/**
 * Strings for component 'qtype_geogebra', language 'zh_cn', version '3.10'.
 *
...
$string['answervar_help'] = '对自动评分：如果学生解决了问题(部分地)，那么 GeoGebra 中的布尔运算对象名称为真。合计所有布尔变量的所有分数。如果任何组合都超过了 100%，那么问题就是正确的，但是至少应该有一个组合的总分恰恰达到 100%。如果要手动评分，请留空。';
