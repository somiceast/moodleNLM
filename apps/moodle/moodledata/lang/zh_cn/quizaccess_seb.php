...
/**
 * Strings for component 'quizaccess_seb', language 'zh_cn', version '3.10'.
 *
...
$string['invalidkeys'] = '无法验证配置密钥或浏览器考试密钥。请确保您使用的是具有正确配置文件的安全考试浏览器。';
...
$string['seb_linkquitseb_help'] = '在此字段中，您可以输入退出 SEB 的链接。它将用于提交考试后显示的页面上的"退出安全考试浏览器"按钮。单击按钮或放在您想放的任何地方的链接时，无需输入退出密码即可退出 SEB。如果未输入任何链接，则"退出安全考试浏览器"按钮不会显示，并且没有链接设置为退出 SEB。';
